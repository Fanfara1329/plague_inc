...
count_people = {'Австралия': '', 'Новая Зеландия': '', 'Новая Гвинея': '', 'Иднонезия': '', 'Филиппины': '',
                'Япония': '', 'Ю.-В. Азия': '', 'Индия': '', 'Гренландия': '', 'Канада': '', 'Мадагаскар': '',
                'Карибы': '', 'Центр. Америка': '', 'Мексика': '', 'США': '', 'Исландия': '', 'Колумбия': '',
                'Бразилия': '', 'Перу': '', 'Боливия': '', 'Аргентина': '', 'Южная Африка': '', 'Ботсвана': '',
                'Зимбабве': '', 'Вост. Африка': ''}
start_screen()
